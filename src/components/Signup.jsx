    ...
    <div className="bg-amber-200 flex flex-col ">
      ...
      <div className="bg-amber-400 flex flex-row justify-between pt-16 pb-16 pr-10.5 pl-17" > 
        ...
        <div className="bg-white border rounded-3xl h-218 border-[#666666] pt-12 pb-35.5 pl-22 pr-37.5 ">  
          <h1 className="text-[32px] font-medium mb-8"> 
            Sign up now
          </h1> 
          <div className="mb-11.75 flex flex-row gap-x-4"> 
            <div className="flex flex-col">
              <label className="text-[#666666] text-sm mb-2">First name</label>
              <input type="text" className="h-14 border rounded-xl border-[#666666] px-4"></input>
            </div>
            <div className="flex flex-col">
              <label className="text-[#666666] text-sm mb-2">Last name</label>
              <input type="text" className="border-[#666666] border h-14 rounded-xl px-4"></input>
            </div>
          </div>
          
          <div className="mb-11.75 flex flex-col">
            <label className="text-[#666666] text-sm mb-2">Email address</label>
            <input type="email" className="border-[#666666] border w-full h-14 rounded-xl px-4"></input>
          </div>
          
          <div className="mb-11.75 flex flex-col">
            <label className="text-[#666666] text-sm mb-2">ID number</label>
            <input type="text" className="border-[#666666] border w-full h-14 rounded-xl px-4"></input>
          </div>
          ...
          <div className="mb-6 flex flex-col">
            ...
            <input type="password" className="border-[#666666] border w-full h-14 rounded-xl px-4"></input>
            <p className="text-xs text-[#666666] mt-2">Use 8 or more characters with a mix of letters, numbers & symbols</p>
          </div>
          
          <div className="flex flex-row justify-between items-center mt-8">
            <button className="w-41 h-16 cursor-pointer bg-[#9C4DF4] rounded-[40px] text-[22px] font-medium text-white">Sign up</button>
            <p className="text-[16px] text-[#666666]">Already have an account? <span className="underline cursor-pointer">Log in</span></p>
          </div>
        </div>
      </div>
    </div>
