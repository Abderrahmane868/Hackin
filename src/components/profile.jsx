  ...
  return(
    <div className="  flex flex-row gap-x-8 bg-[#f9f9fa]">  
      ...
      <div className="pt-8 bg-white pl-20.25 pr-20.25 text-center flex items-center flex-col"> 
        <pre className="text-[#0A033C] font-medium text-[16px] font-serif">Your profile</pre>
        <Image src="/profilephoto.png" height={72} width={72} alt="profile photo" className="pt-9 pb-4" />
        <p className="text-[16px] text-[#0A033C]">Good morning Prashat</p>
        <p className="text-[12px] pb-16 text-[#3F3F3F]">Continue your journey and achieve your target</p>
        <div className="flex flex-row justify-between  w-full pb-9">
          <Image src="/btn.png" height={40} width={40} alt="btn" className="cursor-pointer"/>
          <Image src="/btn1.png" height={40} width={40} alt="btn" className="cursor-pointer"/>
          <Image src="/btn1.png" height={40} width={40} alt="btn" className="cursor-pointer"/>
        </div>
        <p className="font-semibold text-[16px] text-[#3F3F3F] pb-2.5">SETTINGS</p>
